...
namespace Okvee\Profiler;

/**
 * Console logger class.<br>
 * Do not access to this class directly by using new \Okvee\Profiler\Console. Please access this class via Profiler class instead. See $profiler->Console.
 */
class Console extends \Okvee\Profiler\ProfilerBase
{
     ...
     * class constructor
     * 
     * @param \Okvee\Profiler\Profiler $profiler
     */
    public function __construct(\Okvee\Profiler\Profiler $profiler) {
