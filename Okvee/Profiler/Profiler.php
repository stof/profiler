...
class Profiler extends \Okvee\Profiler\ProfilerBase
{
     ...
     * 
     * @var \Okvee\Profiler\Console for access console class
     */
    public $Console;
    ...
    public function __construct() {
        ...
        if (!class_exists('\\Okvee\\Profiler\\Console')) {
            require_once __DIR__.DIRECTORY_SEPARATOR.'Console.php';
        }
        $this->Console = new \Okvee\Profiler\Console($this);
    }// __construct
