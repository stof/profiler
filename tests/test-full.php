...
<html>
    ...
    <body>
        ...
        $okvpDisplayProfilerDb = new okvpDisplayProfilerDb();
        // display profiler window.
        echo $profiler->display($dbh, array($okvpDisplayProfilerDb, 'display'));
        ...
        unset($dbh, $okvpDisplayProfilerDb);
        ?>
    </body>
</html>
/**/